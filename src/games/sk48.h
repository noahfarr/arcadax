...
void sk48_on_set_level(ArcSprites *sprites, const Sk48Static *st, int32_t level, Sk48Aux *aux);

void sk48_step_once(ArcSprites *sprites, const ArcCamera *camera, const Sk48Static *st,
