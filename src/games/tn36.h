...
void tn36_on_set_level(ArcSprites *sprites, const Tn36Static *st, int32_t level,
                       Tn36Aux *aux);

void tn36_step_once(ArcSprites *sprites, const ArcCamera *camera, const Tn36Static *st,
...
void tn36_render_interface(int8_t *frame, const ArcSprites *sprites,
                           const ArcCamera *camera, const Tn36Static *st,
