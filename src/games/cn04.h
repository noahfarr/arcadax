...
void cn04_on_set_level(ArcSprites *sprites, ArcCamera *camera, const Cn04Static *st,
                       int32_t level, Cn04Aux *aux);

void cn04_step_once(ArcSprites *sprites, const ArcCamera *camera, const Cn04Static *st,
