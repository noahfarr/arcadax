...
static void adapt_build_level(ArcSceneGame *game) {
...
static void adapt_step_once(ArcSceneGame *game) {
...
static void adapt_render_interface(ArcSceneGame *game, int8_t *frame) {
    bp35_render_interface(frame, (const Bp35Static *)game->statics, game->engine.level_index,
                          (const Bp35Aux *)game->aux);
}

const ArcSceneHooks bp35_hooks = {adapt_zero_aux, adapt_build_level, adapt_step_once,
