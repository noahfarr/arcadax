...
void su15_on_set_level(ArcSprites *sprites, const Su15Static *st, int32_t level,
                       Su15Aux *aux, int32_t *next_order);

void su15_step_once(ArcSprites *sprites, const ArcCamera *camera, const Su15Static *st,
