...
static void tn36_display_to_grid(const ArcCamera *camera, int32_t display_x, int32_t display_y,
...
static void tn36_rerender_robot(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane,
                                const Tn36Aux *aux) {
...
static int tn36_target_match(const ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane,
                             const Tn36Aux *aux) {
...
static void tn36_checkpoint_scan(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane,
...
static void tn36_toggle_hazards_on_failure(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane) {
...
static void tn36_kill(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane, Tn36Aux *aux,
                      int32_t *next_order) {
    int32_t robot_slot = tn36_robot_slot(st, level, lane);
...
static void tn36_toggle_hazards_blink(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane,
...
static int tn36_hazard_hit(const ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane, int32_t x,
...
static void tn36_try_move_or_scale(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane,
...
static void tn36_execute(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane, int32_t code,
                         Tn36Aux *aux, int32_t *next_order) {
...
static void tn36_begin_success_flash(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane,
                                     Tn36Aux *aux) {
...
static void tn36_end_success(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane, Tn36Aux *aux) {
    tn36_rerender_robot(s, st, level, lane, aux);
    int32_t target_slot = st->target_slot[tn36_li(level, lane)];
    if (target_slot >= 0) {
        int32_t ph = s->atlas->ph, pw = s->atlas->pw;
...
static void tn36_revert_to_checkpoint(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane,
                                      Tn36Aux *aux) {
    int32_t robot_slot = tn36_robot_slot(st, level, lane);
...
static void tn36_finish_or_complete(ArcSprites *s, const Tn36Static *st, int32_t level, Tn36Aux *aux,
...
static void tn36_advance_lane(ArcSprites *s, const Tn36Static *st, int32_t level, Tn36Aux *aux,
    ...
    int32_t ghost_slot = st->num_slots - 2 + lane;
    if (aux->dead[lane]) arc_remove_sprite(s, ghost_slot);
    ...
    if (i > 0) {
        ...
        if (prev_slot >= 0) arc_set_visible(s, prev_slot, 0);
    }
    ...
    if (i >= n) {
        ...
        if (slot >= 0) arc_set_visible(s, slot, 1);
...
static void tn36_set_grid(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane,
    ...
    for (int32_t c = 0; c < n_cols; c++) {
        for (int32_t b = 0; b < n_bits; b++) {
            ...
            arc_color_remap(s, slot, 0, 0, bit_on ? TN36_COLOR_ON : TN36_COLOR_OFF);
        }
    }
}

static void tn36_queue_lane(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane, Tn36Aux *aux) {
    int32_t n_bits = st->num_bits[tn36_li(level, lane)];
...
static void tn36_load_waypoint(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t idx,
                               Tn36Aux *aux) {
...
static void tn36_select_button(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t idx,
                               Tn36Aux *aux) {
    int32_t n = st->num_buttons[level];
...
static void tn36_toggle_cell(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane, int32_t x,
                             int32_t y) {
    int32_t n_cols = st->num_cols[tn36_li(level, lane)];
    int32_t n_bits = st->num_bits[tn36_li(level, lane)];
    int32_t pw = s->atlas->pw;
    ...
    for (int32_t c = 0; c < n_cols; c++) {
        for (int32_t b = 0; b < n_bits; b++) {
            ...
            arc_color_remap(s, slot, 0, 0, cur_on ? TN36_COLOR_OFF : TN36_COLOR_ON);
        }
    }
}

static int tn36_lane_click(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t lane, int32_t x,
    ...
    if (switch_slot >= 0) {
        ...
        if (tn36_box_hit(sb, x, y)) {
            int8_t old = (int8_t)st->switch_color0[tn36_li(level, lane)];
            arc_color_remap(s, switch_slot, 1, old, TN36_SWITCH_HIGHLIGHT);
            aux->switch_flash = 1;
...
static void tn36_route_click(ArcSprites *s, const Tn36Static *st, int32_t level, int32_t x, int32_t y,
                             Tn36Aux *aux) {
...
static void tn36_scroll_tick(ArcSprites *s, const Tn36Static *st, int32_t level, Tn36Aux *aux) {
...
static void tn36_handle_click(ArcSprites *s, const ArcCamera *camera, const Tn36Static *st, int32_t level,
...
void tn36_on_set_level(ArcSprites *sprites, const Tn36Static *st, int32_t level, Tn36Aux *aux) {
    tn36_zero_aux(aux);
    for (int32_t lane = 0; lane < 2; lane++) {
...
void tn36_step_once(ArcSprites *sprites, const ArcCamera *camera, const Tn36Static *st, int32_t level,
...
void tn36_render_interface(int8_t *frame, const ArcSprites *sprites, const ArcCamera *camera,
