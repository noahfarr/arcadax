...
void g50t_on_set_level(ArcSprites *sprites, const G50tStatic *st, int32_t level,
                       G50tAux *aux);

void g50t_step_once(ArcSprites *sprites, const G50tStatic *st, int32_t level,
...
void g50t_render_interface(int8_t *frame, const ArcSprites *sprites,
                           const ArcCamera *camera, const G50tStatic *st,
