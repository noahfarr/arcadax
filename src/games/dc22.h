...
void dc22_step_once(ArcSprites *sprites, const ArcCamera *camera, const Dc22Static *st,
...
void dc22_render_interface(int8_t *frame, const ArcSprites *sprites,
                           const ArcCamera *camera, const Dc22Static *st,
