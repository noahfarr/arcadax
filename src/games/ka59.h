...
void ka59_on_set_level(ArcSprites *sprites, const Ka59Static *st, int32_t level,
                       Ka59Aux *aux, int32_t *next_order);

void ka59_step_once(ArcSprites *sprites, const ArcCamera *camera, const Ka59Static *st,
