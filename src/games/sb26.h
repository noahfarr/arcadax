...
void sb26_on_set_level(ArcSprites *sprites, const Sb26Static *st, int32_t level,
                       Sb26Aux *aux, int32_t *next_order);

void sb26_step_once(ArcSprites *sprites, const ArcCamera *camera, ArcRenderScratch *scratch,
...
void sb26_render_interface(int8_t *frame, const ArcSprites *sprites, const ArcCamera *camera,
                           ArcRenderScratch *scratch, const Sb26Static *st,
                           const Sb26Aux *aux);
