...
static inline int32_t vc33_along(const ArcSprites *s, const Vc33Static *st, int32_t level, int32_t idx) {
    return vc33_horiz(st, level) ? s->x[idx] : s->y[idx];
}

static inline int32_t vc33_along_size(const ArcSprites *s, const Vc33Static *st, int32_t level, int32_t idx) {
    return vc33_horiz(st, level) ? s->w[idx] : s->h[idx];
}

static inline int32_t vc33_perp(const ArcSprites *s, const Vc33Static *st, int32_t level, int32_t idx) {
    return vc33_horiz(st, level) ? s->y[idx] : s->x[idx];
}

static inline int32_t vc33_perp_size(const ArcSprites *s, const Vc33Static *st, int32_t level, int32_t idx) {
    return vc33_horiz(st, level) ? s->h[idx] : s->w[idx];
}

static inline int32_t vc33_front(const ArcSprites *s, const Vc33Static *st, int32_t level, int32_t idx) {
    int32_t a = vc33_along(s, st, level, idx);
    int32_t sz = vc33_along_size(s, st, level, idx);
    return vc33_positive(st, level) ? a + sz : a;
}

static inline int32_t vc33_back(const ArcSprites *s, const Vc33Static *st, int32_t level, int32_t idx) {
    int32_t a = vc33_along(s, st, level, idx);
    int32_t sz = vc33_along_size(s, st, level, idx);
    return vc33_positive(st, level) ? a : a + sz;
}

static int vc33_attached(const ArcSprites *s, const Vc33Static *st, int32_t level,
...
static int32_t vc33_first_pipe(const ArcSprites *s, const Vc33Static *st, int32_t level,
...
static int vc33_coupler_active(const ArcSprites *s, const Vc33Static *st, int32_t level, int32_t coupler_idx) {
    return vc33_first_pipe(s, st, level, coupler_idx, VC33_SIDE_LEFT) >= 0 &&
           vc33_first_pipe(s, st, level, coupler_idx, VC33_SIDE_RIGHT) >= 0;
}

static int32_t vc33_growth_cap(const ArcSprites *s, const Vc33Static *st, int32_t level, int32_t pipe_idx) {
    int has_sensor = 0;
...
static void vc33_write_pipe(ArcSprites *s, int32_t idx, int32_t x, int32_t y, int32_t w, int32_t h) {
    s->x[idx] = x;
    s->y[idx] = y;
    s->w[idx] = w;
    s->h[idx] = h;
...
static void vc33_refresh_couplers(ArcSprites *s, const Vc33Static *st, int32_t level, int32_t *next_order) {
    for (int32_t k = 0; k < VC33_MAX_COUPLERS; k++) arc_remove_sprite(s, st->icon_base + k);
...
static void vc33_resize(ArcSprites *s, const Vc33Static *st, int32_t level, int32_t lever_idx,
                        int32_t *next_order) {
...
static void vc33_sensor_target(const ArcSprites *s, const Vc33Static *st, int32_t level, int32_t i,
...
static void vc33_add_pass(const ArcSprites *s, const Vc33Static *st, int32_t level, int32_t pipe_c,
...
static void vc33_build_queue(const ArcSprites *s, const Vc33Static *st, int32_t level, int32_t coupler_idx,
...
static int vc33_win_check(const ArcSprites *s, const Vc33Static *st, int32_t level) {
    int32_t scount = st->sensor_count[level];
    const int32_t *sslots = st->sensor_slots + (size_t)level * st->max_sensors;
...
static void vc33_resolve(const ArcSprites *s, const Vc33Static *st, int32_t level, const Vc33Aux *aux,
...
static void vc33_display_to_grid(const ArcCamera *camera, int32_t display_x, int32_t display_y,
...
static void vc33_handle_action(ArcSprites *s, const ArcCamera *camera, const Vc33Static *st, int32_t level,
    ...
    if (action_id == VC33_ACTION6) {
        ...
        int32_t hit = on_board ? arc_get_sprite_at(s, wx, wy, -1, 0) : -1;
        ...
        if (is_lever) {
            ...
            if (vc33_coupler_active(s, st, level, hc)) {
                ...
                for (int32_t k = 0; k < VC33_MAX_COUPLERS; k++) {
                    ...
                    if (s->alive[slot]) arc_set_visible(s, slot, 0);
                }
                for (int32_t k = 0; k < VC33_MAX_QUEUE; k++) {
...
static void vc33_continue_queue(ArcSprites *s, const Vc33Static *st, int32_t level, Vc33Aux *aux,
                                int32_t *next_order, int32_t *score, int32_t *status,
                                uint8_t *next_level, uint8_t *action_complete) {
...
void vc33_step_once(ArcSprites *sprites, const ArcCamera *camera, const Vc33Static *st, int32_t level,
                    int32_t action_id, int32_t action_x, int32_t action_y, Vc33Aux *aux,
