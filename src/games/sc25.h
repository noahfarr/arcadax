...
void sc25_on_set_level(ArcSprites *sprites, const Sc25Static *st, int32_t level,
                       Sc25Aux *aux);

void sc25_step_once(ArcSprites *sprites, const ArcCamera *camera, const Sc25Static *st,
...
void sc25_render_interface(int8_t *frame, const ArcSprites *sprites,
                           const ArcCamera *camera, const Sc25Static *st,
