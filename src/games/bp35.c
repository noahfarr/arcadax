...
static void compose(ArcSceneTable *scene, const Bp35Static *st, int32_t level, const int8_t *kind,
...
void bp35_build_level(ArcSceneTable *scene, const Bp35Static *st, int32_t level, int32_t action_id,
    ...
    ArcSceneTable fresh_scene = {f_image, f_x, f_y, f_layer, f_order, NULL, 0, BP35_NUM_SLOTS};
    ...
    ArcSceneTable echo_scene = {e_image, e_x, e_y, e_layer, e_order, NULL, 0, BP35_NUM_SLOTS};
    ...
    const ArcSceneTable *chosen = next_level ? &echo_scene : &fresh_scene;
...
void bp35_step_once(ArcSceneTable *scene, const Bp35Static *st, int32_t level, int32_t action_id,
