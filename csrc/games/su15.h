#ifndef ARCADAX_GAMES_SU15_H
#define ARCADAX_GAMES_SU15_H
...
void su15_on_set_level(Sprites *sprites, const Su15Static *st, int32_t level,
                       Su15Aux *aux, int32_t *next_order);

void su15_step_once(Sprites *sprites, const Camera *camera, const Su15Static *st,
...
void su15_render_interface(int8_t *frame, const Su15Static *st, int32_t level,
                           const Su15Aux *aux);
