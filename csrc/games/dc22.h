#ifndef ARCADAX_GAMES_DC22_H
#define ARCADAX_GAMES_DC22_H
...
void dc22_step_once(Sprites *sprites, const Camera *camera, const Dc22Static *st,
                    int32_t level, int32_t action_id, int32_t action_x,
                    int32_t action_y, Dc22Aux *aux, int32_t *score,
                    int32_t *status, uint8_t *next_level, uint8_t *action_complete);

void dc22_render_interface(int8_t *frame, const Sprites *sprites,
                           const Camera *camera, const Dc22Static *st,
                           int32_t level, const Dc22Aux *aux);
