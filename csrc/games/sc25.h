#ifndef ARCADAX_GAMES_SC25_H
#define ARCADAX_GAMES_SC25_H
...
void sc25_on_set_level(Sprites *sprites, const Sc25Static *st, int32_t level,
                       Sc25Aux *aux);

void sc25_step_once(Sprites *sprites, const Camera *camera, const Sc25Static *st,
                    int32_t level, int32_t action_id, int32_t action_x,
                    int32_t action_y, Sc25Aux *aux, int32_t *score,
                    int32_t *status, uint8_t *next_level,
                    uint8_t *action_complete);

void sc25_render_interface(int8_t *frame, const Sprites *sprites,
                           const Camera *camera, const Sc25Static *st,
                           int32_t level, const Sc25Aux *aux);
