#ifndef ARCADAX_GAMES_TN36_H
#define ARCADAX_GAMES_TN36_H
...
void tn36_on_set_level(Sprites *sprites, const Tn36Static *st, int32_t level,
                       Tn36Aux *aux);

void tn36_step_once(Sprites *sprites, const Camera *camera, const Tn36Static *st,
                    int32_t level, int32_t action_id, int32_t action_x,
                    int32_t action_y, int32_t action_count, Tn36Aux *aux,
                    int32_t *next_order, int32_t *score, int32_t *status,
                    uint8_t *next_level, uint8_t *action_complete);

void tn36_render_interface(int8_t *frame, const Sprites *sprites,
                           const Camera *camera, const Tn36Static *st,
                           int32_t level, const Tn36Aux *aux);
