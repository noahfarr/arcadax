#ifndef ARCADAX_GAMES_SP80_H
#define ARCADAX_GAMES_SP80_H
...
void sp80_on_set_level(Sprites *sprites, const Sp80Static *st, int32_t level,
                       Sp80Aux *aux);
...
void sp80_render_interface(int8_t *frame, const Sprites *sprites,
                           const Camera *camera, const Sp80Static *st,
