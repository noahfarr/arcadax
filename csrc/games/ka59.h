#ifndef ARCADAX_GAMES_KA59_H
#define ARCADAX_GAMES_KA59_H
...
void ka59_on_set_level(Sprites *sprites, const Ka59Static *st, int32_t level,
                       Ka59Aux *aux, int32_t *next_order);

void ka59_step_once(Sprites *sprites, const Camera *camera, const Ka59Static *st,
                    int32_t level, int32_t action_id, int32_t action_x,
                    int32_t action_y, int32_t action_count, Ka59Aux *aux,
