...
static Lp85Engine engine_from_game(const Game *game) {
    Lp85Engine e;
...
static void engine_to_game(Game *game, const Lp85Engine *e) {
...
const Hooks lp85_hooks = {adapt_zero_aux, adapt_on_set_level, adapt_step_once,
