#ifndef ARCADAX_GAMES_AR25_H
#define ARCADAX_GAMES_AR25_H
...
void ar25_on_set_level(Sprites *sprites, const Ar25Static *st, int32_t level,
                       Ar25Aux *aux);
...
void ar25_step_once(Sprites *sprites, const Camera *camera, const Ar25Static *st,
                    ...
                    int32_t action_y, Ar25Aux *aux, int32_t *score,
