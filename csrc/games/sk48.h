#ifndef ARCADAX_GAMES_SK48_H
#define ARCADAX_GAMES_SK48_H
...
#define SK48_EXTRA_SLOTS \
    (SK48_MAX_HEADS * SK48_MAX_SEGMENTS + SK48_MAX_MARKERS + SK48_MAX_SHADOWS)
#define SK48_SEGMENT_BASE(st) ((st)->num_slots - SK48_EXTRA_SLOTS)
#define SK48_MARKER_BASE(st) (SK48_SEGMENT_BASE(st) + SK48_MAX_HEADS * SK48_MAX_SEGMENTS)
...
void sk48_on_set_level(Sprites *sprites, const Sk48Static *st, int32_t level, Sk48Aux *aux);

void sk48_step_once(Sprites *sprites, const Camera *camera, const Sk48Static *st,
                    int32_t level, int32_t action_id, int32_t action_x, int32_t action_y,
                    int32_t action_count, Sk48Aux *aux, int32_t *score, int32_t *status,
