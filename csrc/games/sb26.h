#ifndef ARCADAX_GAMES_SB26_H
#define ARCADAX_GAMES_SB26_H
...
typedef struct {
    ...
    uint8_t peek_active;
    uint8_t *peek_hidden;
    int8_t snapshot[FRAME_SIZE * FRAME_SIZE];
...
void sb26_on_set_level(Sprites *sprites, const Sb26Static *st, int32_t level,
                       Sb26Aux *aux, int32_t *next_order);

void sb26_step_once(Sprites *sprites, const Camera *camera, RenderScratch *scratch,
                    const Sb26Static *st, int32_t level, int32_t action_id,
                    int32_t action_x, int32_t action_y, int32_t action_count,
                    Sb26Aux *aux, int32_t *next_order, int32_t *score,
                    int32_t *status, uint8_t *next_level, uint8_t *action_complete);

void sb26_render_interface(int8_t *frame, const Sprites *sprites, const Camera *camera,
                           RenderScratch *scratch, const Sb26Static *st,
                           const Sb26Aux *aux);
